...
var myW = new widthButton(260, 575, 59, 50, colArray[0][14], colArray[0][14], colArray[0][12], 2, canvas, myShape);
var myW2 = new widthButton(329, 575, 59, 50, colArray[0][14], colArray[0][14], colArray[0][12], 4, canvas, myShape);
var myW3 = new widthButton(398, 575, 59, 50, colArray[0][14], colArray[0][14], colArray[0][12], 6, canvas, myShape);
var myW4 = new widthButton(467, 575, 59, 50, colArray[0][14], colArray[0][14], colArray[0][12], 8, canvas, myShape);
var myW5 = new widthButton(536, 575, 59, 50, colArray[0][14], colArray[0][14], colArray[0][12], 10, canvas, myShape);
var myW6 = new widthButton(605, 575, 59, 50, colArray[0][14], colArray[0][14], colArray[0][12], 12, canvas, myShape);
var myW7 = new widthButton(674, 575, 59, 50, colArray[0][14], colArray[0][14], colArray[0][12], 14, canvas, myShape);
var myW8 = new widthButton(743, 575, 59, 50, colArray[0][14], colArray[0][14], colArray[0][12], 16, canvas, myShape);
var myW9 = new widthButton(812, 575, 59, 50, colArray[0][14], colArray[0][14], colArray[0][12], 18, canvas, myShape);
var myW10 = new widthButton(881, 575, 59, 50, colArray[0][14], colArray[0][14], colArray[0][12], 20, canvas, myShape);

bitmapTwo = new Image();

// to create clear button empty object set - objectset = []
//if button.selected shape = clear and then button.selectedshape = ''
//undo - objectset.pop
objectSet.push(myShape, myS, myS2, myS3, myS4, myS5, 
