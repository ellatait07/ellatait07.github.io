...
class shapeButton{
    ...
    mDown(e){
        //runs boundary check to make sure the mouse is inside the button when it is clicked
        if(this.rectBoundCheck(this.xMouse, this.yMouse, this.x, this.y, this.w, this.h) == true){
            this.rectboundDown = true;
            //stops multiple shapes being selected
            shapeButton.selected = this;
            //used to tell the control object which shape to draw
    ...
    mMove(e){
        //locates the current x and y co-ordinates of the mouse
        this.xMouse = e.offsetX;
        this.yMouse = e.offsetY;

        //runs constant boundary check to make sure the mouse is inside the button
        if(this.rectBoundCheck(this.xMouse, this.yMouse, this.x, this.y, this.w, this.h) == true){
