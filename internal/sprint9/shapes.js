//object which creates a rectangle shape
class Rectangle{
...
//object which creates an ellipse shape
class Ellipse{
    constructor(x, y, w, h, c1){
        this.x = x;
        this.y = y;
...
//object which creates a square shape
class Square{
...
//object which creates a circle shape
class Circle{
    constructor(xM, xMS, yM, yMS, w, h, c1){
        this.xM = xM;
        this.xMS = xMS;
...
//puts the bitmap image on the screen
class DrawImage{
    constructor(im){
        this.im = im;
    }
