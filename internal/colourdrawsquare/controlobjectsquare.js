...
class ControlObjectSquare{
    ...
    update(){
        ...
        this.w = Math.abs(this.xMouse - this.xMouseStart);
        this.h = Math.abs(this.yMouse - this.yMouseStart);

        //side length of square
        this.sqSide = Math.abs(this.h);
        //mouse starting point for the square
        this.sxMouseStart = this.xMouseStart + ((this.w - this.sqSide)/2);
    ...
    draw(){
        ...
        if(this.col){
            ...
            this.drawSquare(this.sxMouseStart, this.yMouseStart, this.sqSide, this.sqSide);
        }
